...
Installing the Blueberry theme can be done in one way: the manual method via a zip file.

## Manual Installation

To install this theme, just download the zip version of this repository and unzip it under `/your/site/grav/user/themes`. Then, rename the folder to `blueberry`. You can find these files on [GitHub](https://github.com/zsuiram/grav-theme-blueberry).
...
* Download the new version of the Blueberry theme from [GitHub](https://github.com/zsuiram/grav-theme-blueberry).
